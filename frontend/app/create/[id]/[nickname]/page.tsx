            ...
            <form onSubmit={handleSubmit} className="container md:max-w-2xl mt-20 px-4 mx-auto">
                <div className="space-y-12 sm:space-y-16">
                    ...
                    <div className="mt-6 flex items-center justify-end gap-x-6">
                        ...
                        <button type="submit" className="inline-flex justify-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600">Publish Job</button>
                    </div>
                </div>
            </form>
        </div>
